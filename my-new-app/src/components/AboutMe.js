...
const AboutMe = () => {
  return (
    <div className = 'aboutMeSection'>
      ...
      <h2>Let's Connect</h2>
      <p>'m open to exciting internship opportunities and collaborations in the world of UX design and beyond. If you're interested in working together or simply want to chat about design, technology, or anything else, feel free to reach out to me. I can't wait to connect and explore the possibilities ahead.
